...
namespace BlogApp.Infrastructure.Migrations
{
    ...
    [Migration("20250416011141_Final")]
    partial class Final
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogApp.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            FirstName = "Admin",
                            LastName = "Admin",
                            PasswordHash = new byte[] { 57, 30, 164, 155, 220, 65, 58, 249, 94, 249, 95, 212, 14, 70, 111, 173, 211, 115, 101, 86, 76, 198, 114, 83, 38, 159, 27, 3, 219, 11, 96, 136, 179, 78, 131, 203, 59, 185, 34, 58, 91, 73, 141, 41, 230, 238, 221, 173, 186, 184, 26, 145, 10, 68, 90, 225, 147, 111, 113, 159, 224, 16, 186, 99 },
                            PasswordSalt = new byte[] { 250, 1, 56, 82, 1, 173, 71, 238, 141, 232, 190, 103, 144, 14, 198, 51, 199, 189, 132, 207, 182, 95, 66, 255, 107, 110, 144, 8, 11, 183, 63, 122, 67, 104, 243, 74, 204, 36, 124, 122, 47, 23, 124, 175, 175, 135, 67, 107, 11, 44, 152, 126, 48, 141, 163, 127, 106, 104, 34, 60, 195, 118, 168, 37, 158, 147, 228, 124, 81, 235, 107, 117, 62, 171, 16, 202, 223, 194, 160, 12, 233, 188, 223, 24, 214, 16, 79, 231, 57, 144, 94, 193, 120, 90, 161, 49, 240, 42, 93, 65, 24, 158, 85, 29, 111, 187, 68, 6, 229, 67, 223, 133, 146, 245, 111, 188, 200, 224, 53, 0, 88, 64, 150, 4, 167, 198, 179, 22 },
                            UserTypeId = 2,
                            Username = "admin"
                        });
                });
